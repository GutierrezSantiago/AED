...
print("Utilice el número '0' para indicar una respuesta negativa y el\
 número \n'1' para indicar una respuesta afirmativa en las preguntas\
  que \nadmitan este tipo de respuestas.")
...
# Tercer ingreso de datos (personal de salud, contacto, viaje al
# exterior, zona de transmision local)
                    print("_"*70)
...
# Resultados
if error:
    print("No se ha podido desarrollar un Cuadro de Diagnóstico debido\
 a la incorrecta carga de datos.")
else:
    print("_"*70)
    print("-"*70)
