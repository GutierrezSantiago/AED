# Sumador ángulos
# Entradca ángulo 1 como g ' "
# Entradca ángulo 2 como g ' "
# Salida Final
# Ángulo suma como g ' "
...
seg_totales_a1 = segundos_a1 + (minutos_a1 * 60) + (grados_a1 * 60**2)
...
# Separo con barras para hacerlo visible pero verlo completo
# al codigo sin ver demasiado hacia la derecha
# (Alt+92 para hacer la barra)
print("*" * 30)
print()
print("Fin.")
print()
input("Presione Enter para final..." )
